INSERT INTO disease (id, disease_name, solution, source_path) VALUES ('1Tomato_Bacterial_spot', '토마토 세균성점무늬병',
                                                                ...
                                                                '/image/result/1Tomato_Bacterial_spot.JPG');

INSERT INTO disease (id, disease_name, solution, source_path) VALUES ('2Tomato_Early_blight', '토마토 겹둥근무늬병',
                                                                '모판에서부터 발생되기 시작하므로 예방위주로 방제를 해야 한다. 또 이 병은 비료상태에 민감하므로 비배관리에 주의해야 한다. 방제약제로는 쿠퍼수화제 500배액, 놀란수화제 1,000배액 등이 있다.',
                                                                '/image/result/2Tomato_Early_blight.JPG');

INSERT INTO disease (id, disease_name, solution, source_path) VALUES ('3Tomato_Late_blight', '토마토 역병',
                                                                '모판에서부터 온도, 습도 관리에 주의하여 저온 다습이 되지 않도록 한다. 특히 11월 - 다음해 4월에 걸쳐 저온기의 재배는 저온다습에 주의한다. ',
                                                                '/image/result/3Tomato_Late_blight.JPG');

INSERT INTO disease (id, disease_name, solution, source_path) VALUES ('4Tomato_Leaf_Mold', '토마토 잎곰팡이병',
                                                                ...
                                                                '/image/result/4Tomato_Leaf_Mold.JPG');

INSERT INTO disease (id, disease_name, solution, source_path) VALUES ('5Tomato_Septoria_leaf_spot', '토마토 흰무늬병',
                                                                '종자를 선별하고, 소독하여 파종한다 재배 시 균형시비를 한다. 병든 잎은 조기에 제거한다. 온실재배 시 내부가 다습하지 않도록 환기를 한다.',
                                                                '/image/result/5Tomato_Septoria_leaf_spot.JPG');

INSERT INTO disease (id, disease_name, solution, source_path) VALUES ('6Tomato_Spider_Mites_Two', '토마토 점박이응애',
                                                                ...
                                                                '/image/result/6Tomato_Spider_Mites_Two.JPG');

INSERT INTO disease (id, disease_name, solution, source_path) VALUES ('7Tomato_Target_Spot', '토마토 표적 반점',
                                                                ...
                                                                '/image/result/7Tomato_Target_Spot.JPG');

INSERT INTO disease (id, disease_name, solution, source_path) VALUES ('8Tomato_YellowLeaf', '토마토황화잎말림바이러스',
                                                                ...
                                                                '/image/result/8Tomato_YellowLeaf.JPG');

INSERT INTO disease (id, disease_name, solution, source_path) VALUES ('9Tomato_Healthy', '건강한 토마토', '이상없음', '/image/result/9Tomato_Healthy.JPG');
